...
public final class ServerboundHello extends BinaryPacket<Serverbound> {
  ...
  public void serialize(DataOutput buffer) {
    try {
      ...
      throw new IllegalStateException("Unable to serialize serverbound hello packet", e);
    }
  }
  ...
  public void deserialize(DataInput buffer) {
    try {
      ...
      throw new IllegalStateException("Unable to deserialize serverbound hello packet", e);
    }
  }
